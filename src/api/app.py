...
@app.get(
    "/articleauthors/", tags=["ArticleAuthors"], response_model=List[PArticleAuthor]
)
...
@app.get(
    "/articleauthors/{id_article}",
    tags=["ArticleAuthors"],
    response_model=PArticleAuthor,
)
...
@app.get(
    "/articlekeywords/", tags=["ArticleKeywords"], response_model=List[PArticleKeyword]
)
...
@app.get(
    "/articlekeywords/{id_article}",
    tags=["ArticleKeywords"],
    response_model=PArticleKeyword,
)
